...
trait DatatableTrait
{
    ...
    {
        return $this->createDatatable($this->model, $request, $route);
    }
    ...
    */
    public function createDatatable($model, $request, $route=NULL)
    {
        if($request->ajax()){
            ...
            $sql_no_urut = $this->getRowNum($tableName.'.'. ($actionId != '' ? $actionId : $tableKey), $request);
            $collection  = $model
    ...
    * @return string sql
    */
    public function getRowNum($primary_key, $request){
