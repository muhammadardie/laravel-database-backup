    ...
    $('body').on('click', '.btn-show-datatable' , function(e) {
      ...
      $.ajax({
        ...
        success: function(res) {
          console.log(res)
          $('#form-detail-backup input[name=storage]').val(res.storage)
          $('#form-detail-backup input[name=source]').val(res.source)
          $('#form-detail-backup input[name=database]').val(res.database)
          $('#form-detail-backup input[name=filename]').val(res.filename)
          $('#form-detail-backup input[name=database]').val(res.database)
          ...
          $('#form-detail-backup input[name=backup_type]').val(res.backup_type)
