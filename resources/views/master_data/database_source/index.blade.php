   ...
   <div class="page-inner">
      <div class="page-header">
         <ul class="breadcrumbs">
            ...
            <li class="nav-item">
               <a href="{{ route('database-source.index') }}">Database Source</a>
            </li>
         </ul>
      </div>
      <div class="row">
         <div class="col-md-12">
            <div class="card">
               <div class="card-header">
                  <button class="btn btn-primary btn-add" data-toggle="modal" data-target="#modal-create-database-source">
...
<script>
   $(function() {
       var t = $('#table').DataTable({
         processing: true,
         serverSide: true,
         ajax: '{{ route('database-source.ajaxDatatable') }}',
         columns: [
...
@include('master_data.database_source.create')
@include('master_data.database_source.show')
@include('master_data.database_source.edit')
